 ...
 */
@Entity
@Table(name = "DistributorDifferentialBonus")
@NamedQuery(name="DistributorDifferentialBonus.findAll", query="SELECT a FROM DistributorDifferentialBonus a")
public class DistributorDifferentialBonus extends TreeNode {
    ...
    // reward = opv*reate - child.opv*rate - DistributorBonus
