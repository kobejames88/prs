...
@Configuration
@EnableJpaRepositories(basePackages = "com.perfectchina.bns.repositories",
...
public class JpaConfiguration {
	...
	@Value("${datasource.bns.maxPoolSize:10}")
	...
	@Bean
	@Primary
	@ConfigurationProperties(prefix = "datasource.bns")
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.perfectchina.bns.model",
													 "com.perfectchina.bns.model.treenode"});
	...
	private Properties jpaProperties() {
		...
		if(StringUtils.isNotEmpty(environment.getRequiredProperty("datasource.bns.defaultSchema"))){
			properties.put("hibernate.default_schema", environment.getRequiredProperty("datasource.bns.defaultSchema"));
		}
		return properties;
	}
